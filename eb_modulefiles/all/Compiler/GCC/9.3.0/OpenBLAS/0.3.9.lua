...
local root = "/home/software/EasyBuild/software/OpenBLAS/0.3.9-GCC-9.3.0"
...
setenv("EBVERSIONOPENBLAS", "0.3.9")
setenv("EBDEVELOPENBLAS", pathJoin(root, "easybuild/Compiler-GCC-9.3.0-OpenBLAS-0.3.9-easybuild-devel"))
