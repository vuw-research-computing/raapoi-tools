...
local root = "/home/software/EasyBuild/software/OpenMPI/4.0.3-GCC-9.3.0"
...
if not ( isloaded("UCX/1.8.0") ) then
    load("UCX/1.8.0")
end
...
prepend_path("MODULEPATH", "/home/software/tools/eb_modulefiles/all/MPI/GCC/9.3.0/OpenMPI/4.0.3")
...
setenv("EBDEVELOPENMPI", pathJoin(root, "easybuild/Compiler-GCC-9.3.0-OpenMPI-4.0.3-easybuild-devel"))
