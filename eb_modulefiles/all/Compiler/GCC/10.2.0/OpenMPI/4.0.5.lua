...
local root = "/home/software/EasyBuild/software/OpenMPI/4.0.5-GCC-10.2.0"
...
if not ( isloaded("UCX/1.9.0") ) then
    load("UCX/1.9.0")
end
...
prepend_path("MODULEPATH", "/home/software/tools/eb_modulefiles/all/MPI/GCC/10.2.0/OpenMPI/4.0.5")
...
setenv("EBDEVELOPENMPI", pathJoin(root, "easybuild/Compiler-GCC-10.2.0-OpenMPI-4.0.5-easybuild-devel"))
