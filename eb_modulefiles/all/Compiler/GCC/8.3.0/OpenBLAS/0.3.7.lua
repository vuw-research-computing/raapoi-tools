...
local root = "/home/software/EasyBuild/software/OpenBLAS/0.3.7-GCC-8.3.0"
...
setenv("EBDEVELOPENBLAS", pathJoin(root, "easybuild/Compiler-GCC-8.3.0-OpenBLAS-0.3.7-easybuild-devel"))
