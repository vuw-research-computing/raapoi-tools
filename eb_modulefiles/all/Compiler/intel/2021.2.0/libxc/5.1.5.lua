...
local root = "/home/software/EasyBuild/software/libxc/5.1.5-intel-compilers-2021.2.0"
...
setenv("EBVERSIONLIBXC", "5.1.5")
setenv("EBDEVELLIBXC", pathJoin(root, "easybuild/Compiler-intel-2021.2.0-libxc-5.1.5-easybuild-devel"))
