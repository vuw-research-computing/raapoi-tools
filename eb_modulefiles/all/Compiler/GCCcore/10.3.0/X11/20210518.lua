...
local root = "/home/software/EasyBuild/software/X11/20210518-GCCcore-10.3.0"
...
if not ( isloaded("fontconfig/2.13.93") ) then
    load("fontconfig/2.13.93")
end
...
setenv("EBDEVELX11", pathJoin(root, "easybuild/Compiler-GCCcore-10.3.0-X11-20210518-easybuild-devel"))
