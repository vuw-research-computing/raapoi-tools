...
local root = "/home/software/EasyBuild/software/hwloc/2.4.1-GCCcore-10.3.0"
...
setenv("EBVERSIONHWLOC", "2.4.1")
setenv("EBDEVELHWLOC", pathJoin(root, "easybuild/Compiler-GCCcore-10.3.0-hwloc-2.4.1-easybuild-devel"))
