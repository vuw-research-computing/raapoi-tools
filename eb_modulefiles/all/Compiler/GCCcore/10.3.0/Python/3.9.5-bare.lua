...
local root = "/home/software/EasyBuild/software/Python/3.9.5-GCCcore-10.3.0-bare"
...
setenv("EBDEVELPYTHON", pathJoin(root, "easybuild/Compiler-GCCcore-10.3.0-Python-3.9.5-bare-easybuild-devel"))
