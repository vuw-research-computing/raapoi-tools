...
local root = "/home/software/EasyBuild/software/PCRE2/10.36-GCCcore-10.3.0"
...
setenv("EBVERSIONPCRE2", "10.36")
setenv("EBDEVELPCRE2", pathJoin(root, "easybuild/Compiler-GCCcore-10.3.0-PCRE2-10.36-easybuild-devel"))
