...
local root = "/home/software/EasyBuild/software/PMIx/3.2.3-GCCcore-10.3.0"
...
setenv("EBVERSIONPMIX", "3.2.3")
setenv("EBDEVELPMIX", pathJoin(root, "easybuild/Compiler-GCCcore-10.3.0-PMIx-3.2.3-easybuild-devel"))
