...
local root = "/home/software/EasyBuild/software/Xvfb/1.20.11-GCCcore-10.3.0"
...
if not ( isloaded("nettle/3.7.2") ) then
    load("nettle/3.7.2")
end
...
setenv("EBVERSIONXVFB", "1.20.11")
setenv("EBDEVELXVFB", pathJoin(root, "easybuild/Compiler-GCCcore-10.3.0-Xvfb-1.20.11-easybuild-devel"))
