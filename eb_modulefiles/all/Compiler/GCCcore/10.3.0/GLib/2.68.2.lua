...
local root = "/home/software/EasyBuild/software/GLib/2.68.2-GCCcore-10.3.0"
...
if not ( isloaded("PCRE2/10.36") ) then
    load("PCRE2/10.36")
end
...
setenv("EBDEVELGLIB", pathJoin(root, "easybuild/Compiler-GCCcore-10.3.0-GLib-2.68.2-easybuild-devel"))
