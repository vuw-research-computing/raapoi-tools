...
local root = "/home/software/EasyBuild/software/Ghostscript/9.54.0-GCCcore-10.3.0"
...
if not ( isloaded("GLib/2.68.2") ) then
    load("GLib/2.68.2")
end
...
setenv("EBDEVELGHOSTSCRIPT", pathJoin(root, "easybuild/Compiler-GCCcore-10.3.0-Ghostscript-9.54.0-easybuild-devel"))
