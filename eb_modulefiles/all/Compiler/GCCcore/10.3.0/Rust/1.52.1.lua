...
local root = "/home/software/EasyBuild/software/Rust/1.52.1-GCCcore-10.3.0"
...
setenv("EBDEVELRUST", pathJoin(root, "easybuild/Compiler-GCCcore-10.3.0-Rust-1.52.1-easybuild-devel"))
