...
local root = "/home/software/EasyBuild/software/GLPK/5.0-GCCcore-10.3.0"
...
setenv("EBDEVELGLPK", pathJoin(root, "easybuild/Compiler-GCCcore-10.3.0-GLPK-5.0-easybuild-devel"))
