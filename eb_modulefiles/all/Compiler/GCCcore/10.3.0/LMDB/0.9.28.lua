...
local root = "/home/software/EasyBuild/software/LMDB/0.9.28-GCCcore-10.3.0"
...
setenv("EBVERSIONLMDB", "0.9.28")
setenv("EBDEVELLMDB", pathJoin(root, "easybuild/Compiler-GCCcore-10.3.0-LMDB-0.9.28-easybuild-devel"))
