...
local root = "/home/software/EasyBuild/software/intltool/0.51.0-GCCcore-9.3.0"

conflict("intltool")

if not ( isloaded("Perl/5.30.2") ) then
    load("Perl/5.30.2")
end
...
setenv("EBDEVELINTLTOOL", pathJoin(root, "easybuild/Compiler-GCCcore-9.3.0-intltool-0.51.0-easybuild-devel"))
