...
local root = "/home/software/EasyBuild/software/Bison/3.5.3-GCCcore-9.3.0"
...
setenv("EBVERSIONBISON", "3.5.3")
setenv("EBDEVELBISON", pathJoin(root, "easybuild/Compiler-GCCcore-9.3.0-Bison-3.5.3-easybuild-devel"))
