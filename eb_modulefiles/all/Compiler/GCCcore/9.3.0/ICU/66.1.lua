...
local root = "/home/software/EasyBuild/software/ICU/66.1-GCCcore-9.3.0"
...
setenv("EBVERSIONICU", "66.1")
setenv("EBDEVELICU", pathJoin(root, "easybuild/Compiler-GCCcore-9.3.0-ICU-66.1-easybuild-devel"))
