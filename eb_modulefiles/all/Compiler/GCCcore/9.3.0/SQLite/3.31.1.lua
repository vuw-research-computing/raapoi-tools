...
local root = "/home/software/EasyBuild/software/SQLite/3.31.1-GCCcore-9.3.0"
...
setenv("EBVERSIONSQLITE", "3.31.1")
setenv("EBDEVELSQLITE", pathJoin(root, "easybuild/Compiler-GCCcore-9.3.0-SQLite-3.31.1-easybuild-devel"))
