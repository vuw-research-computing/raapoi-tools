...
local root = "/home/software/EasyBuild/software/flex/2.6.4-GCCcore-9.3.0"
...
setenv("EBDEVELFLEX", pathJoin(root, "easybuild/Compiler-GCCcore-9.3.0-flex-2.6.4-easybuild-devel"))
