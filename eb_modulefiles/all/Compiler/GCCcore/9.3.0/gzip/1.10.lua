...
local root = "/home/software/EasyBuild/software/gzip/1.10-GCCcore-9.3.0"
...
setenv("EBDEVELGZIP", pathJoin(root, "easybuild/Compiler-GCCcore-9.3.0-gzip-1.10-easybuild-devel"))
