...
local root = "/home/software/EasyBuild/software/Ghostscript/9.52-GCCcore-9.3.0"
...
setenv("EBVERSIONGHOSTSCRIPT", "9.52")
setenv("EBDEVELGHOSTSCRIPT", pathJoin(root, "easybuild/Compiler-GCCcore-9.3.0-Ghostscript-9.52-easybuild-devel"))
