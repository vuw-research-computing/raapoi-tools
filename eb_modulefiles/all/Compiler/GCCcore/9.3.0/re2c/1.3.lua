...
local root = "/home/software/EasyBuild/software/re2c/1.3-GCCcore-9.3.0"
...
setenv("EBVERSIONRE2C", "1.3")
setenv("EBDEVELRE2C", pathJoin(root, "easybuild/Compiler-GCCcore-9.3.0-re2c-1.3-easybuild-devel"))
