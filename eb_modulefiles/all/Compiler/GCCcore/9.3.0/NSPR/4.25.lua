...
local root = "/home/software/EasyBuild/software/NSPR/4.25-GCCcore-9.3.0"
...
setenv("EBVERSIONNSPR", "4.25")
setenv("EBDEVELNSPR", pathJoin(root, "easybuild/Compiler-GCCcore-9.3.0-NSPR-4.25-easybuild-devel"))
