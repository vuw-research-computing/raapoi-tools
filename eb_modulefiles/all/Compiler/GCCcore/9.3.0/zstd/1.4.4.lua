...
local root = "/home/software/EasyBuild/software/zstd/1.4.4-GCCcore-9.3.0"
...
setenv("EBVERSIONZSTD", "1.4.4")
setenv("EBDEVELZSTD", pathJoin(root, "easybuild/Compiler-GCCcore-9.3.0-zstd-1.4.4-easybuild-devel"))
