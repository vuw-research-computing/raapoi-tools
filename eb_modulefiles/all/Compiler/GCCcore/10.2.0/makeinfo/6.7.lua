...
local root = "/home/software/EasyBuild/software/makeinfo/6.7-GCCcore-10.2.0"
...
setenv("EBDEVELMAKEINFO", pathJoin(root, "easybuild/Compiler-GCCcore-10.2.0-makeinfo-6.7-easybuild-devel"))
