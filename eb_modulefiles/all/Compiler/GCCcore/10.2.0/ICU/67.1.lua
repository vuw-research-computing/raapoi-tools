...
local root = "/home/software/EasyBuild/software/ICU/67.1-GCCcore-10.2.0"
...
setenv("EBVERSIONICU", "67.1")
setenv("EBDEVELICU", pathJoin(root, "easybuild/Compiler-GCCcore-10.2.0-ICU-67.1-easybuild-devel"))
