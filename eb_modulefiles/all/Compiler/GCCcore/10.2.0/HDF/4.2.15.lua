...
local root = "/home/software/EasyBuild/software/HDF/4.2.15-GCCcore-10.2.0"
...
if not ( isloaded("libtirpc/1.3.1") ) then
    load("libtirpc/1.3.1")
end
...
setenv("EBDEVELHDF", pathJoin(root, "easybuild/Compiler-GCCcore-10.2.0-HDF-4.2.15-easybuild-devel"))
