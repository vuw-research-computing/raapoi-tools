...
local root = "/home/software/EasyBuild/software/zstd/1.4.5-GCCcore-10.2.0"
...
if not ( isloaded("lz4/1.9.2") ) then
    load("lz4/1.9.2")
end
...
setenv("EBVERSIONZSTD", "1.4.5")
setenv("EBDEVELZSTD", pathJoin(root, "easybuild/Compiler-GCCcore-10.2.0-zstd-1.4.5-easybuild-devel"))
