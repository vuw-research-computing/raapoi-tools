...
local root = "/home/software/EasyBuild/software/libtirpc/1.3.1-GCCcore-10.2.0"
...
setenv("EBVERSIONLIBTIRPC", "1.3.1")
setenv("EBDEVELLIBTIRPC", pathJoin(root, "easybuild/Compiler-GCCcore-10.2.0-libtirpc-1.3.1-easybuild-devel"))
