...
local root = "/home/software/EasyBuild/software/libjpeg-turbo/2.0.5-GCCcore-10.2.0"
...
setenv("EBVERSIONLIBJPEGMINTURBO", "2.0.5")
setenv("EBDEVELLIBJPEGMINTURBO", pathJoin(root, "easybuild/Compiler-GCCcore-10.2.0-libjpeg-turbo-2.0.5-easybuild-devel"))
