...
local root = "/home/software/EasyBuild/software/NLopt/2.6.2-GCCcore-10.2.0"
...
setenv("EBVERSIONNLOPT", "2.6.2")
setenv("EBDEVELNLOPT", pathJoin(root, "easybuild/Compiler-GCCcore-10.2.0-NLopt-2.6.2-easybuild-devel"))
