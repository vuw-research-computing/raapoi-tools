...
local root = "/home/software/EasyBuild/software/libgd/2.3.0-GCCcore-10.2.0"
...
setenv("EBDEVELLIBGD", pathJoin(root, "easybuild/Compiler-GCCcore-10.2.0-libgd-2.3.0-easybuild-devel"))
