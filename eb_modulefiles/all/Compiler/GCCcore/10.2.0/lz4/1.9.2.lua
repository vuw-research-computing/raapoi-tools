...
local root = "/home/software/EasyBuild/software/lz4/1.9.2-GCCcore-10.2.0"
...
setenv("EBVERSIONLZ4", "1.9.2")
setenv("EBDEVELLZ4", pathJoin(root, "easybuild/Compiler-GCCcore-10.2.0-lz4-1.9.2-easybuild-devel"))
