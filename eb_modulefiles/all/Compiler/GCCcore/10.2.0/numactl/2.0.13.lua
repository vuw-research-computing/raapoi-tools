...
local root = "/home/software/EasyBuild/software/numactl/2.0.13-GCCcore-10.2.0"
...
setenv("EBVERSIONNUMACTL", "2.0.13")
setenv("EBDEVELNUMACTL", pathJoin(root, "easybuild/Compiler-GCCcore-10.2.0-numactl-2.0.13-easybuild-devel"))
