...
Included extensions
===================
Algorithm::Dependency-1.112, Algorithm::Diff-1.1903, aliased-0.34,
AnyEvent-7.17, App::Cmd-0.331, App::cpanminus-1.7044, AppConfig-1.71,
Archive::Extract-0.86, Array::Transpose-0.06, Array::Utils-0.5,
Authen::NTLM-1.09, Authen::SASL-2.16, AutoLoader-5.74,
B::Hooks::EndOfScope-0.24, B::Lint-1.20, boolean-0.46, Business::ISBN-3.005,
Business::ISBN::Data-20191107, Canary::Stability-2013, Capture::Tiny-0.48,
...
Class::Load::XS-0.10, Class::Singleton-1.5, Class::Trigger-0.15, Clone-0.45,
Clone::Choose-0.010, common::sense-3.75, Config::General-2.63,
Config::INI-0.025, Config::MVP-2.200011, Config::Simple-4.58,
Config::Tiny-2.24, constant-1.33, CPANPLUS-0.9908, Crypt::DES-2.07,
Crypt::Rijndael-1.14, Cwd-3.75, Cwd::Guard-0.05, Data::Dump-1.23,
...
Date::Language-2.33, DateTime-1.52, DateTime::Locale-1.26,
DateTime::TimeZone-2.39, DateTime::Tiny-1.07, DBD::CSV-0.55, DBD::SQLite-1.64,
DBI-1.643, DBIx::Admin::TableInfo-3.03, DBIx::ContextualFetch-1.03,
DBIx::Simple-1.37, Devel::CheckCompiler-0.07, Devel::CheckLib-1.14,
Devel::GlobalDestruction-0.14, Devel::OverloadInfo-0.005,
Devel::StackTrace-2.04, Digest::HMAC-1.03, Digest::MD5::File-0.08,
Digest::SHA1-2.13, Dist::CheckConflicts-0.11, Dist::Zilla-6.015,
Email::Date::Format-1.005, Encode-3.07, Encode::Locale-1.05, Error-0.17029,
Eval::Closure-0.14, Exception::Class-1.44, Expect-1.35, Exporter-5.74,
Exporter::Declare-0.114, Exporter::Tiny-1.002002, ExtUtils::CBuilder-0.280234,
ExtUtils::Config-0.008, ExtUtils::Constant-0.25, ExtUtils::CppGuess-0.21,
ExtUtils::Helpers-0.026, ExtUtils::InstallPaths-0.012,
ExtUtils::MakeMaker-7.46, ExtUtils::ParseXS-3.35, Fennec::Lite-0.004,
...
File::Listing-6.04, File::Next-1.18, File::Path-2.17, File::pushd-1.016,
...
Getopt::Long-2.52, Getopt::Long::Descriptive-0.105, Git-0.42, GO-0.04,
GO::Utils-0.15, Graph-0.9704, Graph::ReadWrite-2.09, Hash::Merge-0.302,
HTML::Entities::Interpolate-1.10, HTML::Form-6.07, HTML::Parser-3.72,
HTML::Tagset-3.20, HTML::Tree-5.07, HTTP::Cookies-6.08, HTTP::Daemon-6.12,
HTTP::Date-6.05, HTTP::Negotiate-6.01, HTTP::Request-6.25, HTTP::Tiny-0.076,
if-0.0608, Ima::DBI-0.35, Import::Into-1.002005, Inline-0.86,
IO::Compress::Bzip2-2.096, IO::File-1.42, IO::Handle-1.42, IO::HTML-1.001,
IO::Seekable-1.42, IO::Select-1.42, IO::Socket-1.42, IO::Socket::SSL-2.068,
IO::String-1.08, IO::Stringy-2.113, IO::Tty-1.14, IPC::Cmd-1.04,
IPC::Run-20200505.0, IPC::Run3-0.048, JSON-4.02, JSON::XS-4.03,
Lingua::EN::PluralToSingular-0.21, List::AllUtils-0.16, List::MoreUtils-0.428,
List::MoreUtils::XS-0.430, List::SomeUtils-0.58, List::Util-1.55,
List::UtilsBy-0.11, Locale::Maketext::Simple-0.21, Log::Dispatch-2.70,
Log::Dispatchouli-2.021, Log::Handler-0.90, Log::Log4perl-1.50,
Log::Message-0.08, Log::Message::Simple-0.10, Logger::Simple-2.0,
LWP::MediaTypes-6.04, LWP::Protocol::https-6.09, LWP::Simple-6.47,
Mail::Util-2.21, Math::Bezier-0.01, Math::CDF-0.1, Math::Round-0.07,
Math::VecStat-0.08, MCE::Mutex-1.874, Meta::Builder-0.004, MIME::Base64-3.15,
MIME::Lite-3.031, MIME::Types-2.17, Mixin::Linewise::Readers-0.108,
Mock::Quick-1.111, Module::Build-0.4231, Module::Build::Tiny-0.039,
Module::Build::XSUtil-0.19, Module::CoreList-5.20200717,
Module::Implementation-0.09, Module::Install-1.19, Module::Load-0.34,
Module::Load::Conditional-0.72, Module::Metadata-1.000037,
Module::Pluggable-5.2, Module::Runtime-0.016, Moo-2.004000, Moose-2.2013,
...
namespace::clean-0.27, Net::Domain-3.11, Net::HTTP-6.19, Net::SMTP::SSL-1.04,
Net::SNMP-v6.0.1, Net::SSLeay-1.88, Number::Compare-0.03, Number::Format-1.75,
...
Params::Util-1.07, Params::Validate-1.29, Params::ValidationCompiler-0.30,
parent-0.238, Parse::RecDescent-1.967015, Path::Tiny-0.114, PDF::API2-2.037,
Perl::OSType-1.010, PerlIO::utf8_strict-0.007, Pod::Elemental-0.103005,
Pod::Escapes-1.07, Pod::Eventual-0.094001, Pod::LaTeX-0.61, Pod::Man-4.14,
Pod::Plainer-1.04, Pod::POM-2.01, Pod::Simple-3.40, Pod::Weaver-4.015,
Readonly-2.05, Regexp::Common-2017060201, Role::HasMessage-0.006,
Role::Identifiable::HasIdent-0.007, Role::Tiny-2.001004,
Scalar::List::Utils-1.55, Scalar::Util-1.55, Scalar::Util::Numeric-0.40,
Set::Array-0.30, Set::IntervalTree-0.12, Set::IntSpan-1.19,
Set::IntSpan::Fast-1.15, Set::Scalar-1.29, Shell-0.73, Socket-2.030,
Software::License-0.103014, Specio-0.46, SQL::Abstract-1.87,
SQL::Statement-1.412, Statistics::Basic-1.6611,
Statistics::Descriptive-3.0702, Storable-3.15, strictures-2.000006,
...
Term::ReadKey-2.38, Term::ReadLine::Gnu-1.36, Term::UI-0.46, Test-1.26,
Test::ClassAPI-1.07, Test::Deep-1.130, Test::Differences-0.67,
Test::Exception-0.43, Test::Fatal-0.016, Test::Harness-3.42,
Test::LeakTrace-0.16, Test::More-1.302177, Test::Most-0.37,
Test::NoWarnings-1.04, Test::Output-1.031, Test::Pod-1.52,
Test::Requires-0.11, Test::RequiresInternet-0.05, Test::Simple-1.302177,
Test::Version-2.09, Test::Warn-0.36, Test::Warnings-0.030, Text::Aligner-0.16,
Text::Balanced-2.03, Text::CSV-2.00, Text::CSV_XS-1.44, Text::Diff-1.45,
Text::Format-0.61, Text::Glob-0.11, Text::Iconv-1.7, Text::ParseWords-3.30,
...
Types::Serialiser-1.0, UNIVERSAL::moniker-0.08, URI-1.76, URI::Escape-1.76,
version-0.9924, Want-0.29, WWW::RobotRules-6.02, XML::Bare-0.53,
