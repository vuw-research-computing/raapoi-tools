...
local root = "/home/software/EasyBuild/software/Eigen/3.3.8-GCCcore-10.2.0"
...
setenv("EBVERSIONEIGEN", "3.3.8")
setenv("EBDEVELEIGEN", pathJoin(root, "easybuild/Compiler-GCCcore-10.2.0-Eigen-3.3.8-easybuild-devel"))
