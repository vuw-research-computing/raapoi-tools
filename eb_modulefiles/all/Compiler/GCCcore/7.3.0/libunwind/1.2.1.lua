...
local root = "/home/software/EasyBuild/software/libunwind/1.2.1-GCCcore-7.3.0"
...
setenv("EBVERSIONLIBUNWIND", "1.2.1")
setenv("EBDEVELLIBUNWIND", pathJoin(root, "easybuild/Compiler-GCCcore-7.3.0-libunwind-1.2.1-easybuild-devel"))
