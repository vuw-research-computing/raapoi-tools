...
local root = "/home/software/EasyBuild/software/util-linux/2.32-GCCcore-7.3.0"
...
setenv("EBVERSIONUTILMINLINUX", "2.32")
setenv("EBDEVELUTILMINLINUX", pathJoin(root, "easybuild/Compiler-GCCcore-7.3.0-util-linux-2.32-easybuild-devel"))
