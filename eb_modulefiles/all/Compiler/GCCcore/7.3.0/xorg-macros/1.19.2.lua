...
local root = "/home/software/EasyBuild/software/xorg-macros/1.19.2-GCCcore-7.3.0"
...
setenv("EBDEVELXORGMINMACROS", pathJoin(root, "easybuild/Compiler-GCCcore-7.3.0-xorg-macros-1.19.2-easybuild-devel"))
