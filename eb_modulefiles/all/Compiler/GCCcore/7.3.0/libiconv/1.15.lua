...
local root = "/home/software/EasyBuild/software/libiconv/1.15-GCCcore-7.3.0"
...
setenv("EBVERSIONLIBICONV", "1.15")
setenv("EBDEVELLIBICONV", pathJoin(root, "easybuild/Compiler-GCCcore-7.3.0-libiconv-1.15-easybuild-devel"))
