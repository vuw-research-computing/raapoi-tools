...
local root = "/home/software/EasyBuild/software/X11/20180604-GCCcore-7.3.0"
...
if not ( isloaded("fontconfig/2.13.0") ) then
    load("fontconfig/2.13.0")
end
...
setenv("EBVERSIONX11", "20180604")
setenv("EBDEVELX11", pathJoin(root, "easybuild/Compiler-GCCcore-7.3.0-X11-20180604-easybuild-devel"))
