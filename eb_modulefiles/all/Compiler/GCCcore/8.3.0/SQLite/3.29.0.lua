...
local root = "/home/software/EasyBuild/software/SQLite/3.29.0-GCCcore-8.3.0"
...
setenv("EBVERSIONSQLITE", "3.29.0")
setenv("EBDEVELSQLITE", pathJoin(root, "easybuild/Compiler-GCCcore-8.3.0-SQLite-3.29.0-easybuild-devel"))
