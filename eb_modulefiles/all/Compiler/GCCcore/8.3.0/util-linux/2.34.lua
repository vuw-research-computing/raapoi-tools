...
local root = "/home/software/EasyBuild/software/util-linux/2.34-GCCcore-8.3.0"
...
setenv("EBVERSIONUTILMINLINUX", "2.34")
setenv("EBDEVELUTILMINLINUX", pathJoin(root, "easybuild/Compiler-GCCcore-8.3.0-util-linux-2.34-easybuild-devel"))
