...
local root = "/home/software/EasyBuild/software/X11/20190717-GCCcore-8.3.0"
...
if not ( isloaded("fontconfig/2.13.1") ) then
    load("fontconfig/2.13.1")
end
...
setenv("EBVERSIONX11", "20190717")
setenv("EBDEVELX11", pathJoin(root, "easybuild/Compiler-GCCcore-8.3.0-X11-20190717-easybuild-devel"))
