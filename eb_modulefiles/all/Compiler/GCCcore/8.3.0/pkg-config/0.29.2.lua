...
local root = "/home/software/EasyBuild/software/pkg-config/0.29.2-GCCcore-8.3.0"
...
setenv("EBDEVELPKGMINCONFIG", pathJoin(root, "easybuild/Compiler-GCCcore-8.3.0-pkg-config-0.29.2-easybuild-devel"))
