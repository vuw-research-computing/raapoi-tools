...
local root = "/home/software/EasyBuild/software/libjpeg-turbo/2.0.3-GCCcore-8.3.0"
...
setenv("EBVERSIONLIBJPEGMINTURBO", "2.0.3")
setenv("EBDEVELLIBJPEGMINTURBO", pathJoin(root, "easybuild/Compiler-GCCcore-8.3.0-libjpeg-turbo-2.0.3-easybuild-devel"))
