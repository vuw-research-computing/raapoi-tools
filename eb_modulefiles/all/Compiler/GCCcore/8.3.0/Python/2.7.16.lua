...
idna-2.8, imagesize-1.1.0, importlib_metadata-0.22, intervaltree-3.0.2,
ipaddress-1.0.22, Jinja2-2.10.1, joblib-0.13.2, liac-arff-2.4.0,
MarkupSafe-1.1.1, mock-3.0.5, more-itertools-5.0.0, netaddr-0.7.19,
...
Pygments-2.4.2, PyNaCl-1.3.0, pyparsing-2.4.2, pytest-4.6.5, python-
dateutil-2.8.0, pytz-2019.2, requests-2.22.0, scandir-1.10.0,
setuptools-41.2.0, setuptools_scm-3.3.3, singledispatch-3.4.0.3, six-1.12.0,
snowballstemmer-1.9.1, sortedcontainers-2.1.0, Sphinx-1.8.5, sphinxcontrib-
websupport-1.1.2, tabulate-0.8.3, typing-3.7.4.1, ujson-1.35, urllib3-1.25.3,
...
local root = "/home/software/EasyBuild/software/Python/2.7.16-GCCcore-8.3.0"
