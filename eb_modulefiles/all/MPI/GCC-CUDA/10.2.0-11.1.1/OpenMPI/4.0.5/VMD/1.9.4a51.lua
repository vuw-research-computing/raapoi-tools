...
local root = "/home/software/EasyBuild/software/VMD/1.9.4a51-fosscuda-2020b"
...
if not ( isloaded("OptiX/6.5.0") ) then
    load("OptiX/6.5.0")
end
...
setenv("EBDEVELVMD", pathJoin(root, "easybuild/MPI-GCC-CUDA-10.2.0-11.1.1-OpenMPI-4.0.5-VMD-1.9.4a51-easybuild-devel"))
