...
local root = "/home/software/EasyBuild/software/torchvision/0.8.2-fosscuda-2020b-PyTorch-1.7.1"
...
if not ( isloaded("PyTorch/1.7.1") ) then
    load("PyTorch/1.7.1")
end

prepend_path("CMAKE_PREFIX_PATH", root)
setenv("EBROOTTORCHVISION", root)
setenv("EBVERSIONTORCHVISION", "0.8.2")
setenv("EBDEVELTORCHVISION", pathJoin(root, "easybuild/MPI-GCC-CUDA-10.2.0-11.1.1-OpenMPI-4.0.5-torchvision-0.8.2-PyTorch-1.7.1-easybuild-devel"))
