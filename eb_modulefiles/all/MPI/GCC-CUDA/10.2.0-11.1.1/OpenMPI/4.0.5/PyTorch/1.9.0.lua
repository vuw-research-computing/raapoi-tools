...
local root = "/home/software/EasyBuild/software/PyTorch/1.9.0-fosscuda-2020b"
...
setenv("EBVERSIONPYTORCH", "1.9.0")
setenv("EBDEVELPYTORCH", pathJoin(root, "easybuild/MPI-GCC-CUDA-10.2.0-11.1.1-OpenMPI-4.0.5-PyTorch-1.9.0-easybuild-devel"))
