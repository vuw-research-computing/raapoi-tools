...
local root = "/home/software/EasyBuild/software/HDF5/1.10.5-gompi-2019b"
...
setenv("EBDEVELHDF5", pathJoin(root, "easybuild/MPI-GCC-8.3.0-OpenMPI-3.1.4-HDF5-1.10.5-easybuild-devel"))

setenv("HDF5_DIR", "/home/software/EasyBuild/software/HDF5/1.10.5-gompi-2019b")
