...
local root = "/home/software/EasyBuild/software/ScaLAPACK/2.1.0-gompi-2020b"
...
setenv("EBDEVELSCALAPACK", pathJoin(root, "easybuild/MPI-GCC-10.2.0-OpenMPI-4.0.5-ScaLAPACK-2.1.0-easybuild-devel"))
