...
local root = "/home/software/EasyBuild/software/FFTW/3.3.8-gompi-2020b"
...
setenv("EBDEVELFFTW", pathJoin(root, "easybuild/MPI-GCC-10.2.0-OpenMPI-4.0.5-FFTW-3.3.8-easybuild-devel"))
