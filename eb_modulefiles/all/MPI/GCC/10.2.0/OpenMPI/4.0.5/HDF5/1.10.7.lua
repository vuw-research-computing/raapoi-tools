...
local root = "/home/software/EasyBuild/software/HDF5/1.10.7-gompi-2020b"
...
setenv("EBDEVELHDF5", pathJoin(root, "easybuild/MPI-GCC-10.2.0-OpenMPI-4.0.5-HDF5-1.10.7-easybuild-devel"))

setenv("HDF5_DIR", "/home/software/EasyBuild/software/HDF5/1.10.7-gompi-2020b")
