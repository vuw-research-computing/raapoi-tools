...
local root = "/home/software/EasyBuild/software/GDAL/3.0.4-foss-2020a-Python-3.8.2"
...
if not ( isloaded("GEOS/3.8.1-Python-3.8.2") ) then
    load("GEOS/3.8.1-Python-3.8.2")
end
...
if not ( isloaded("PROJ/7.0.0") ) then
    load("PROJ/7.0.0")
end
...
if not ( isloaded("HDF5/1.10.6") ) then
    load("HDF5/1.10.6")
end
...
setenv("EBVERSIONGDAL", "3.0.4")
setenv("EBDEVELGDAL", pathJoin(root, "easybuild/MPI-GCC-9.3.0-OpenMPI-4.0.3-GDAL-3.0.4-Python-3.8.2-easybuild-devel"))
