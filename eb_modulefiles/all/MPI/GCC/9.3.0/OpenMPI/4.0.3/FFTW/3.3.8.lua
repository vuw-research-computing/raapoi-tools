...
local root = "/home/software/EasyBuild/software/FFTW/3.3.8-gompi-2020a"
...
setenv("EBDEVELFFTW", pathJoin(root, "easybuild/MPI-GCC-9.3.0-OpenMPI-4.0.3-FFTW-3.3.8-easybuild-devel"))
