...
local root = "/home/software/EasyBuild/software/Stacks/2.54-foss-2020a"
...
setenv("EBVERSIONSTACKS", "2.54")
setenv("EBDEVELSTACKS", pathJoin(root, "easybuild/MPI-GCC-9.3.0-OpenMPI-4.0.3-Stacks-2.54-easybuild-devel"))
