...
local root = "/home/software/EasyBuild/software/netCDF/4.7.4-gompi-2020a"
...
setenv("EBDEVELNETCDF", pathJoin(root, "easybuild/MPI-GCC-9.3.0-OpenMPI-4.0.3-netCDF-4.7.4-easybuild-devel"))
