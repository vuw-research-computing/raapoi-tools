...
local root = "/home/software/EasyBuild/software/ScaLAPACK/2.1.0-gompi-2020a"
...
setenv("EBDEVELSCALAPACK", pathJoin(root, "easybuild/MPI-GCC-9.3.0-OpenMPI-4.0.3-ScaLAPACK-2.1.0-easybuild-devel"))
