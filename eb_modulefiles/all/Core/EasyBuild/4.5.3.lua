...
local root = "/home/software/EasyBuild/software/EasyBuild/4.5.3"
...
setenv("EBVERSIONEASYBUILD", "4.5.3")
setenv("EBDEVELEASYBUILD", pathJoin(root, "easybuild/Core-EasyBuild-4.5.3-easybuild-devel"))
