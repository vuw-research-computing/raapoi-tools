...
local root = "/home/software/EasyBuild/software/EasyBuild/4.6.0"
...
setenv("EBVERSIONEASYBUILD", "4.6.0")
setenv("EBDEVELEASYBUILD", pathJoin(root, "easybuild/Core-EasyBuild-4.6.0-easybuild-devel"))
