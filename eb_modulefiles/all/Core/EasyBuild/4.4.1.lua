...
local root = "/home/software/EasyBuild/software/EasyBuild/4.4.1"
...
setenv("EBVERSIONEASYBUILD", "4.4.1")
setenv("EBDEVELEASYBUILD", pathJoin(root, "easybuild/Core-EasyBuild-4.4.1-easybuild-devel"))
