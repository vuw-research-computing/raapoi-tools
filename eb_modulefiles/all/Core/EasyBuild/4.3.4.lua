...
local root = "/home/software/EasyBuild/software/EasyBuild/4.3.4"
...
setenv("EBVERSIONEASYBUILD", "4.3.4")
setenv("EBDEVELEASYBUILD", pathJoin(root, "easybuild/Core-EasyBuild-4.3.4-easybuild-devel"))
