...
local root = "/home/software/EasyBuild/software/EasyBuild/4.5.5"
...
setenv("EBVERSIONEASYBUILD", "4.5.5")
setenv("EBDEVELEASYBUILD", pathJoin(root, "easybuild/Core-EasyBuild-4.5.5-easybuild-devel"))
