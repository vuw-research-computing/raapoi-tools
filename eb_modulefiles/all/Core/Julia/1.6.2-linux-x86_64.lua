...
local root = "/home/software/EasyBuild/software/Julia/1.6.2-linux-x86_64"
...
setenv("EBVERSIONJULIA", "1.6.2")
setenv("EBDEVELJULIA", pathJoin(root, "easybuild/Core-Julia-1.6.2-linux-x86_64-easybuild-devel"))
