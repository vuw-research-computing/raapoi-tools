...
local root = "/home/software/EasyBuild/software/ncurses/6.1-GCCcore-8.2.0"

conflict("devel/ncurses")
...
setenv("EBDEVELNCURSES", pathJoin(root, "easybuild/devel-ncurses-6.1-GCCcore-8.2.0-easybuild-devel"))
